...
public class jdbcLecture {
    public static void main(String[] args) throws SQLException {
        ...
        //Connect to the datatbase by providing the URL, user, and the password of the user we want to connect as.
...
//        stmt.executeQuery("SELECT * FROM albums");
        ...
        stmt.executeUpdate(insertQuery, Statement.RETURN_GENERATED_KEYS);  //purple because constant from static generated class
