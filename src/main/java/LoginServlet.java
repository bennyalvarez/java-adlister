...
//        // therefore we need to explicitly case the object ot the correct type.
...
//
//        // destorys the session and/or when person wants to logout ex coz using public computer.
//        session.invalidate();
